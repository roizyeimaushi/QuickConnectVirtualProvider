        ...
        <Card>
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
                <div className="bg-muted/50 p-3 rounded-lg">
                    ...
                    <p className="font-medium text-sm">{session.schedule?.name || session.name || "Standard Shift"}</p>
                </div>
                <div className="bg-muted/50 p-3 rounded-lg">
                    <p className="text-xs text-muted-foreground mb-1">Schedule</p>
                    <p className="font-medium text-sm">
                        {formatTime24(session.schedule?.time_in || session.start_time)} - {formatTime24(session.schedule?.time_out || session.end_time)}
                    </p>
                </div>
            </CardContent>
        </Card>
