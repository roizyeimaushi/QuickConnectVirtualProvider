    ...
    return (
        <DashboardLayout title="Profile">
            <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
                {/* Back Link - HARDCODED FOR EMPLOYEE */}
                <div>
                    <Link
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            disabled // Employees cannot change names
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        disabled // Employees cannot change email usually, defaulting to disabled for compliance
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            value={user?.schedule?.name || "Night Shift"}
                                            className="pl-9 bg-muted/50"
                                            disabled
                                        />
                                    </div>
